    ...
    <div className="w-full min-h-screen flex flex-col justify-between bg-white prompt relative">
      <div className="container mx-auto flex items-center relative">
        <div className="w-full flex flex-col items-center justify-center p-10">
          ...
          <form
            className="w-full flex flex-col justify-center items-center mt-5 space-y-6"
            action="/signup"
          >
            <Input
              className="w-full py-2.5 pl-4 text-sm text-[#626060] border border-[#B4B4B4] border-1 rounded-[50px] outline-none"
              type="text"
              name="firstname"
      ...
      <div className="signup_line_footer_watermark relative w-full bottom-0 overflow-hidden">
        <img className="w-full scale-150" src={footer_watermark} alt="" />
      </div>
    </div>
  );
}
